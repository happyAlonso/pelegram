...
private:
    ...
    uint32_t connectedNoDataCount = 0; // consecutive times the socket connected but no byte arrived before it dropped
    uint32_t connectFailedCount = 0; // consecutive times the socket never came up at all
